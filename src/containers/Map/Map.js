...
import {H, platform, defaultLayers} from './Credentials/Credentials'
...
class Map extends React.Component {
   ...
   componentDidMount() {
      ...
      map.addEventListener('dragend', (event) => {
         ...
         reverseGeocode(coords, cb => this.setState({map, addressTitle: cb.title, dragLoading: false}))
      })
      ...
      reverseGeocode(this.props.coords, cb => this.setState({map, addressTitle: cb.title, dragLoading: false}))
   }
